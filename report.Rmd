...
```{r cleaning variable names, setting variable type and working of cost , cache=TRUE}
...
```{r cleaning event type, cache=TRUE}
...
```{r building working data frames, cache=TRUE}
...
```{r financial figures,fig.width=12,fig.height=5}
par(mfrow=(c(1,2)))
...
```{r health figures, fig.width=12, fig.height=5}
par(mfrow=(c(1,2)))
